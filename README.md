...
Шаг 1. Согласно заданной схеме, строим топологию сети, по которой будет выполняться задание.

![](/kartinko/Image_0005.png)

Шаг 2. На каждом роутере создаем сообщение дня (MOTD) с указанием своего ФИО, номером группы и порядковым номером в журнале.
...
Шаг 3. Переименовываем устройства по шаблону "сокращенное название страны-сокращенное название города-сокращенная роль устройства-порядковый номер устройства"
